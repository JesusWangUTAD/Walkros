...
public class AlertWalkrosNormal : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (distant <= 2)//Si es menos o igual a 1 (Rango)
        {
            animator.SetBool("Detect", false);
            animator.SetBool("StillDetecting", true);//Pasa al estado Attack
